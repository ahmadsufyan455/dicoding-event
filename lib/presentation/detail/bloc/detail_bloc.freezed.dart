...
mixin _$DetailState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(EventEntity event) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(EventEntity event)? success,
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(this.event);
  ...
  @override
  String toString() {
    return 'DetailState.success(event: $event)';
  }
...
abstract class _Success implements DetailState {
  const factory _Success(final EventEntity event) = _$SuccessImpl;
